        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    Administración de tipo Componente
                </h1>
                <ol class="breadcrumb">
                    <li>
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="glyphicon glyphicon-plus-sign"></span> Agregar Tipo Componente</h3>
                    <span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-up"></i></span>
                </div>
                <div class="panel-body">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Nuevo Tipo Componente</h3>
                        </div>
                       
                        <?php echo form_open(base_url("index.php/c_tipo_componente/insertar_tipo_componente")); ?>
                        <div class="panel-body">
...
?>
                            ...
                            <div class="container col-md-12">
                                <div class="form-group">
                                    <label>Ingrese el nombre del tipo componente</label>
